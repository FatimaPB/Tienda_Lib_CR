...
describe('InsigniasComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [
        InsigniasComponent,
        HttpClientTestingModule // <-- permite inyectar HttpClient
      ],
      providers: [
  ...
  it('debería cargar las insignias al iniciar', () => {
    expect(mockService.obtenerTodas).toHaveBeenCalled();
    expect(component.insignias.length).toBe(1);
  });

  it('debería llenar el formulario al editar una insignia', () => {
    const ins: Insignia = {
      id: 1,
      nombre: 'Fe',
  ...
  it('debería llamar a crear al guardar una nueva insignia', () => {
  ...
  it('debería llamar a actualizar al guardar una insignia editada', () => {
