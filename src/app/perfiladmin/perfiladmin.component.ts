...
@Component({
  ...
  standalone: true,
  imports: [CommonModule,DialogModule,PasswordModule,FloatLabelModule, FormsModule,MatIconModule,CardModule,ConfirmDialogModule, ButtonModule,TagModule,BadgeModule,ToastModule, AvatarModule, DividerModule, InputTextModule, InputGroupModule],
  templateUrl: './perfiladmin.component.html',
  styleUrl: './perfiladmin.component.css',
  providers: [MessageService,ConfirmationService] // Proveedor para el servicio de mensajes
})
